...
import datetime
from sqlalchemy import String, Integer, BigInteger, Numeric, UniqueConstraint, ForeignKey
...
class FinancialRatio(Base):
    ...
    financial_ratios_id: Mapped[int] = mapped_column(BigInteger, primary_key=True, autoincrement=True)
